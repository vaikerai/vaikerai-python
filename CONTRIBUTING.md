...
```sh
cd your/checkout/of/vaikerai-python
...
- `VAIKERAI_API_BASE_URL`: Defaults to `https://api.vaikerai.com` but can be overriden to point the client at a development host.
- `VAIKERAI_API_TOKEN`: Required. Find your token at https://vaikerai.com/#token

## Publishing a release

This project has a [GitHub Actions workflow](/.github/workflows/ci.yaml) that publishes the `vaikerai` package to PyPI. The release process is triggered by manually creating and pushing a new git tag.
...
Then visit [github.com/vaikerai/vaikerai-python/actions](https://github.com/vaikerai/vaikerai-python/actions) to monitor the release process.
