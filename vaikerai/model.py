...
from vaikerai.identifier import ModelVersionIdentifier
from vaikerai.pagination import Page
from vaikerai.prediction import (
    Prediction,
    _create_prediction_body,
    _json_to_prediction,
)
from vaikerai.resource import Namespace, Resource
from vaikerai.version import Version, Versions
...
class Model(Resource):
    """
    A machine learning model hosted on VaikerAI.
    """
    ...
    def predict(self, *args, **kwargs) -> None:
        """
        DEPRECATED: Use `vaikerai.run()` instead.
        """

        raise VaikerAIException(
            "The `model.predict()` method has been removed, because it's unstable: if a new version of the model you're using is pushed and its API has changed, your code may break. Use `vaikerai.run()` instead. See https://github.com/vaikerai/vaikerai-python#readme"
        )
...
class Models(Namespace):
    ...
    class CreateModelParams(TypedDict):
        ...
        Possible values can be found by calling `vaikerai.hardware.list()`."""
