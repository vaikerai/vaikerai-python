...
if TYPE_CHECKING:
    from vaikerai.prediction import Prediction


class VaikerAIException(Exception):
    """A base class for all VaikerAI exceptions."""


class ModelError(VaikerAIException):
...
class VaikerAIError(VaikerAIException):
    """
    An error from VaikerAI's API.
    ...
    @classmethod
    def from_response(cls, response: httpx.Response) -> "VaikerAIError":
        """Create a VaikerAIError from an HTTP response."""
